...
const SearchMovies = () => {
    ...
    return (
        <form className="form" onSubmit={searchMovies}>
            ...
            <input className="input" value={query} type="text" name="query" placeholder="i.e. Joker" />
            <button type="submit" className="button" onSubmit={handleQuerySearch}>Search</button>
        </form>
    );
}
